...
public class CategoriaController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<NewCategoriaResponse> editCategoria(@PathVariable UUID id, @RequestBody NewCategoriaRequest categoria) {
        return ResponseEntity.ok(categoriaService.editCategoria(id, categoria));
    }
}
